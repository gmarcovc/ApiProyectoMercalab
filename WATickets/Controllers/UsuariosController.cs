        ...
        public HttpResponseMessage Post([FromBody] Usuarios usuarios)
        {
            try
            {
                ...
                if (Usuario == null)
                {
                    ...
                    Usuario.Activo = true;
                    Usuario.Cedula = usuarios.Cedula;

                    var Cedula = db.Usuarios.Where(a => a.Cedula == usuarios.Cedula).FirstOrDefault();
                    if(Cedula != null)
                    {
                        throw new Exception("Ya existe un usuario con esta cedula");
                    }
        ...
        public HttpResponseMessage Put([FromBody] Usuarios usuarios)
        {
            try
            {
                ...
                if (Usuarios != null)
                {
                    ...
                    if (!string.IsNullOrEmpty(usuarios.Cedula))
                    {
                        Usuarios.Cedula = usuarios.Cedula;
                    }
                    var Cedula = db.Usuarios.Where(a => a.Cedula == usuarios.Cedula && a.id != usuarios.id).FirstOrDefault();
                    if (Cedula != null)
                    {
                        throw new Exception("Ya existe un usuario con esta cedula");
                    }
