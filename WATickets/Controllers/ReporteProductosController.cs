...
{
    [Authorize]
    public class ReporteProductosController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> Get([FromUri] Filtros filtro)
        {
            try
            {
                ...
                var SQL = Parametros.SQLReporteProductos;
                ...
                SQL = SQL.Replace("@FechaInicial", FechaInicio).Replace("@FechaFinal", FechaFinal);
                ...
                return Request.CreateResponse(HttpStatusCode.OK, db.Database.SqlQuery<ReporteProductos>(SQL).ToList());
            }
            catch (Exception ex1)
            {
